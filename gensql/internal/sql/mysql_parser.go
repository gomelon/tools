...
func NewMySQLParser(sql string) (*mySQLParser, error) {
...
func (m *mySQLParser) Type() (Type, error) {
	switch m.stmt.(type) {
...
func (m *mySQLParser) SelectColumns() ([]*Column, error) {
...
func (m *mySQLParser) selectColumn(selectExpr sqlparser.SelectExpr) (*Column, error) {
	column := &Column{}
